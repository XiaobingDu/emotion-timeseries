...
CUDA_VISIBLE_DEVICES=0 python train_co_attn.py  --strategy five_fold --batch_size 64 --LSTM_hidden 1024 --overlap with --save_file 1110_final_withGCN_1layer_output256_lamda09_MLL_win120_over30 --log_dir 0916_five_fold --lamda 0.9 --fold_id 1 --path1 ../EEG_PSD_9_DOM/   --path2 ../DOM_feature_all/DOM_featureAll.mat
...
#
CUDA_VISIBLE_DEVICES=0 python train_co_attn.py  --strategy five_fold --batch_size 64 --LSTM_hidden 1024 --overlap with --save_file 1110_final_withGCN_1layer_output256_lamda09_MLL_win120_over30 --log_dir 0916_five_fold --lamda 0.9 --fold_id 2 --path1 ../EEG_PSD_9_DOM/   --path2 ../DOM_feature_all/DOM_featureAll.mat
...
#
CUDA_VISIBLE_DEVICES=0 python train_co_attn.py  --strategy five_fold --batch_size 64 --LSTM_hidden 1024 --overlap with --save_file 1110_final_withGCN_1layer_output256_lamda09_MLL_win120_over30 --log_dir 0916_five_fold --lamda 0.9 --fold_id 3 --path1 ../EEG_PSD_9_DOM/   --path2 ../DOM_feature_all/DOM_featureAll.mat
...
#
CUDA_VISIBLE_DEVICES=0 python train_co_attn.py  --strategy five_fold --batch_size 64 --LSTM_hidden 1024 --overlap with --save_file 1110_final_withGCN_1layer_output256_lamda09_MLL_win120_over30 --log_dir 0916_five_fold --lamda 0.9 --fold_id 4 --path1 ../EEG_PSD_9_DOM/   --path2 ../DOM_feature_all/DOM_featureAll.mat
...
#
CUDA_VISIBLE_DEVICES=0 python train_co_attn.py  --strategy five_fold --batch_size 64 --LSTM_hidden 1024 --overlap with --save_file 1110_final_withGCN_1layer_output256_lamda09_MLL_win120_over30 --log_dir 0916_five_fold --lamda 0.9 --fold_id 5 --path1 ../EEG_PSD_9_DOM/   --path2 ../DOM_feature_all/DOM_featureAll.mat

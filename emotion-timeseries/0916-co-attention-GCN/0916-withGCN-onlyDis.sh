...
CUDA_VISIBLE_DEVICES=1 python train_co_attn.py  --strategy five_fold --batch_size 64 --LSTM_hidden 1024 --overlap without --save_file 0916_save_epoch_result_dis --log_dir 0916_five_fold --lamda 1.0 --fold_id 1 --path1 ../EEG_PSD_9_DOM/   --path2 ../DOM_feature_all/DOM_featureAll.mat
...
#
CUDA_VISIBLE_DEVICES=1 python train_co_attn.py  --strategy five_fold --batch_size 64 --LSTM_hidden 1024 --overlap without --save_file 0916_save_epoch_result_dis --log_dir 0916_five_fold --lamda 1.0 --fold_id 2 --path1 ../EEG_PSD_9_DOM/   --path2 ../DOM_feature_all/DOM_featureAll.mat
...
#
CUDA_VISIBLE_DEVICES=1 python train_co_attn.py  --strategy five_fold --batch_size 64 --LSTM_hidden 1024 --overlap without --save_file 0916_save_epoch_result_dis --log_dir 0916_five_fold --lamda 1.0 --fold_id 3 --path1 ../EEG_PSD_9_DOM/   --path2 ../DOM_feature_all/DOM_featureAll.mat
...
#
CUDA_VISIBLE_DEVICES=1 python train_co_attn.py  --strategy five_fold --batch_size 64 --LSTM_hidden 1024 --overlap without --save_file 0916_save_epoch_result_dis --log_dir 0916_five_fold --lamda 1.0 --fold_id 4 --path1 ../EEG_PSD_9_DOM/   --path2 ../DOM_feature_all/DOM_featureAll.mat
...
#
CUDA_VISIBLE_DEVICES=1 python train_co_attn.py  --strategy five_fold --batch_size 64 --LSTM_hidden 1024 --overlap without --save_file 0916_save_epoch_result_dis --log_dir 0916_five_fold --lamda 1.0 --fold_id 5 --path1 ../EEG_PSD_9_DOM/   --path2 ../DOM_feature_all/DOM_featureAll.mat

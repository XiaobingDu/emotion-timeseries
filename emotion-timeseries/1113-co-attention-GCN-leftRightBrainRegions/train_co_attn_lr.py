...
mutilabel_criterion = torch.nn.BCEWithLogitsLoss()
...
for epoch_num in range(num_epochs):
    ...
    for i, data in enumerate(trDataloader):
        ...
        # Forward pass
        predict, input_clstm, shared_encoder, att_1 = net(train, left, right, dis)
        #get GC
        ...
        # # label-based-ranking
        # train_aucMacro = aucMacro(dom_label, predict)
        # train_aucMicro = aucMicro(dom_label, predict)
        # train_aucInstance = aucInstance(dom_label, predict)
    ...
    for i, data in enumerate(valDataloader):
        ...
        # Forward pass
        predict, input_clstm, shared_encoder, att_1 = net(val, left, right, dis)
...
for i, data in enumerate(testDataloader):
    ...
    # Forward pass
    predict, input_clstm, shared_encoder, att_1 = net(test, left, right, dis)

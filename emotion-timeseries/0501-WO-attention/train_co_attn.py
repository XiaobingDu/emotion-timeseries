...
for epoch_num in range(num_epochs):
    ...
    for i, data in enumerate(trDataloader):
        ...
        # Forward pass
        predict, input_clstm, shared_encoder = net(train, Frontal, Temporal, Central, Parietal, Occipital, dis)
        #get GC
    ...
    for i, data in enumerate(valDataloader):
        ...
        # Forward pass
        predict, input_clstm, shared_encoder = net(val, Frontal, Temporal, Central, Parietal, Occipital, dis)
...
for i, data in enumerate(testDataloader):
    ...
    # Forward pass
    predict, input_clstm, shared_encoder = net(test, Frontal, Temporal, Central, Parietal, Occipital, dis)

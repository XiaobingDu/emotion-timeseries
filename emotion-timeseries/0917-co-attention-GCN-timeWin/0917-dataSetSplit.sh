...
CUDA_VISIBLE_DEVICES=1 python train_co_attn.py  --strategy split --batch_size 64 --LSTM_hidden 1024 --overlap without --save_file 0917_split --log_dir 0917_split --lamda 1.0 --fold_id 1 --path1 ../EEG_PSD_9_DOM/   --path2 ../DOM_feature_all/DOM_featureAll.mat
